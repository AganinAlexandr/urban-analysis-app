#!/usr/bin/env python3
"""
Применение нормализации групп к базе данных (исправленная версия)
"""
import sys
import os
...
def apply_group_normalization_fixed():
    """Применяет нормализацию групп к базе данных"""
    print("=== ПРИМЕНЕНИЕ НОРМАЛИЗАЦИИ ГРУПП (ИСПРАВЛЕННАЯ ВЕРСИЯ) ===")
...
if __name__ == "__main__":
    apply_group_normalization_fixed() 