...
class SentimentComparison:
    ...
    def plot_comparison(self, df: pd.DataFrame):
        ...
        plt.tight_layout()
        plt.savefig('diagrams/sentiment_distribution_comparison.png')
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('diagrams/sentiment_correlation_comparison.png')
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('diagrams/sentiment_rating_comparison.png')
        plt.close()
